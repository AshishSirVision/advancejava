...
public class EditServlet extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.print("<table>");
		out.print("<tr><td></td><td><input type='text' disabled name='id' value='" + e1.getId1() + "'/></td></tr>");
		...
		out.print("<tr><td>Course:</td><td><input type='course' name='course' value='" + e1.getCourse1()
				+ "'/></td></tr>");
