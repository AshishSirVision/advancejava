...
public class ViewServlet1 extends HttpServlet {  
    protected void doGet(HttpServletRequest request, HttpServletResponse response)   
        ...
        out.print("<tr><th>Id</th><th>Name</th><th>Age</th><th>Course</th><th>City</th><th>Edit</th><th>Delete</th></tr>");  
         for(stu e1:list){      
         out.print("<tr><td>"+e1.getId1()+"</td><td>"+e1.getName1()+"</td><td>"+e1.getAge1()+"</td><td>"+e1.getCourse1()+"</td><td>"+e1.getCity1()+"</td><td><a href='update.jsp?id="+e1.getId1()+"'>edit</a></td><td><a href='DeleteServlet?id="+e1.getId1()+"'>delete</a></td></tr>"); 
